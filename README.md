...
* [server-host](https://github.com/chiefbigrubberduck/Linux-Utils/wiki/server-host) - A tiny shell script to automate the hosting of a server using the `python -m http.server` command. Not ready yet.
